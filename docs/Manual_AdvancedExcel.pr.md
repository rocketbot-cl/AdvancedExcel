...
|Url|URL para a qual o hiperlink apontará.|A2|
...
|Parâmetros|Descrição|exemplo|
| --- | --- | --- |
|Planilha|Nome da planilha onde o texto será escrito|Planilha 1|
|Célula inicial ou intervalo|Célula onde a escrita começará ou intervalo disponível para escrever o texto. Se um intervalo for especificado, a escrita pode ser mais lenta.|A1|
|Texto/Dados|Texto para escrever no excel|Dados para escrever|
|Transformar quebras de linha|Se marcado, as quebras de linha separarão o texto em linhas diferentes||
|Transformar tabulações|Se marcado, os espaços de tabulação separarão o texto em colunas diferentes||
|Ajuste automático de celdas|Ajusta a altura e a largura das células de acordo com o comprimento do texto no intervalo especificado. Se apenas for especificada a célula inicial, todas as células serão ajustadas.||
